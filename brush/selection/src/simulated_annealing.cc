...
namespace FT{
    ...
    namespace Sel{
        ...
        vector<size_t> SimAnneal::select(CPopulation& pop, const CParameters& params)
        {
        ...
        vector<size_t> SimAnneal::survive(CPopulation& pop, const CParameters& params)
        {
